...
int main(int argc, char *argv[]){
    ...
    std::cout<<"Adaptive Control Variates parallel: "<<iter<<" iterations."<<std::endl;
    string int_tech = "CV";
    integrate(viltrum::integrator_adaptive_control_variates_parallel(viltrum::nested(viltrum::simpson,viltrum::trapezoidal),iter,spp),sol,
    ...
    std::string filename = name + int_tech + "_i" + to_string(iter) + "_s" + to_string(spp) + ".hdr";
